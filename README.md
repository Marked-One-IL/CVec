...
Vec_resize - resize the vector. If the new size is bigger the sections are set to 0<br>
Vec_resizeV - resize the vector. If the new size is bigger the sections are set to a given value<br>
